"use client";
import { updateTrainingPlanTitle } from "@/actions/admin/matches";
...
export const PlanTitleForm = ({ header, initialData }: Props) => {
  ...
  const onSubmit = async (values: z.infer<typeof trainingPlanTitleSchema>) => {
    const { success } = await updateTrainingPlanTitle({
                ...
                <FormItem>
                  <FormControl>
                    <Input
                      ...
                      placeholder="Daniel's forehand custom plan."
                      {...field}
                    />
                  </FormControl>
